"""Execution-facing fall service helpers.

This module owns the mock emergency-dispatch side effects for the active fall
flow. Moving this logic out of the API route layer allows the assessment and
conversation services to depend on a stable domain service instead of a route
module.
"""
